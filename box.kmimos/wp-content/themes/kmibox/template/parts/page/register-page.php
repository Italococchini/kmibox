		...
		<div class="row">
			<form class="form-horizontal" id="form-registro" method="post">
				...
				<div class="row row-special">					
					<div class="col-md-6 form-group">
						<i class="fa fa-asterisk fa-especial" aria-hidden="true"></i>
						<input type="text" name="telef_movil" data-charset="num" class="form-control col-md-6" id="inputEmail3" placeholder="Teléfono móvil" minlength="10"  maxlength="20">
					</div>
					<div class="col-md-6 form-group">
						<input type="text" name="telef_fijo" data-charset="num" class="form-control col-md-6" id="inputEmail3" placeholder="Teléfono fijo"  minlength="10" maxlength="20">
					</div>
				</div>
				<div class="row row-special">					
				...
				<div class="row row-special">					
					...
					<div class="col-md-6 form-group">
						<i class="fa fa-asterisk fa-especial" aria-hidden="true"></i>
						<input type="text" name="dir_cod_postal" data-charset="numalf" class="form-control col-md-6" id="inputEmail3" placeholder="Código postal" maxlength="15">
					</div>
				</div>
