...
<section data-fase="6" class="container">
	...
	<article class="col-md-6 col-md-offset-3 text-center <?php echo ($result['visible'])? '' : 'hidden' ; ?>"  style="border-radius:30px;padding:20px;border:1px solid #ccc;">
		<aside class="col-md-12 text-center">
			<h1 style="font-size: 60px; font-weight: bold; color: #00d8b5;">¡Felicidades!</h1>
			<h4 style="color:#ccc;">Tu suscripción a Kmibox ha sido un éxito</h4>
		</aside>
			...
			<form class="form-horizontal" method="post" action="#" id="form-pago" >
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-4	col-sm-4">
			      <a href="<?php echo get_home_url(); ?>/quiero-mi-kmibox" class="btn  <?php echo (isset($hidden))? '' : 'hidden' ; ?>  btn-sm-kmibox">Quiero mi kmibox</a>
			      <button type="submit" class="btn <?php echo (isset($hidden))? 'hidden' : '' ; ?> btn-sm-kmibox">Realizar Pago</button>
			    </div>
				<div class="col-sm-3">
