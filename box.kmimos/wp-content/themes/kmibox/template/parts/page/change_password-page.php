		...
		<div class="col-md-10 col-md-offset-1 form-horizontal">
			...
			<form id='form-change-password' class="form-horizontal" method="post">
				...
				<div class="form-group inter-input-icon">
					...
					<input type="password" name="clave" class="form-control" id="inputEmail3" placeholder="Ingrese su nueva contraseña">
				</div>

				<div class="form-group inter-input-icon">
					<i class="fa fa-lock "></i>
					<input type="password" name="confirm_clave" class="form-control" id="inputEmail3" placeholder="Ingrese su nueva contraseña">
				</div>
