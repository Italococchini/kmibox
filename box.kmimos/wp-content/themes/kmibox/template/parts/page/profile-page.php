		...
		<div class="row form-horizontal">
			...
			<div class="col-md-12">
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="nombre" class="form-control profile-content-input" id="inputEmail3" placeholder="Nombre"
						value="<?php echo $user['first_name']; ?>">
				</div>
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="apellido" class="form-control profile-content-input" id="inputEmail3" placeholder="Apellido"
			...
			<div class="col-md-12">
				...
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="mascota" class="form-control profile-content-input " id="inputEmail3" placeholder="Nombre de la Mascota"
						value="<?php echo $user['mascota']; ?>">				
				</div>
			</div>
			<div class="col-md-12">
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="telef_movil" class="form-control profile-content-input " id="inputEmail3" placeholder="Teléfono móvil"
						value="<?php echo $user['telef_movil']; ?>">
				</div>
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="telef_fijo" class="form-control profile-content-input " id="inputEmail3" placeholder="Teléfono fijo"
			...
			<div class="col-md-12">
				<div class="col-md-12 form-group">
					<select class="has-error form-control profile-content-input" name="dondo_conociste">
						<option value="<?php echo $user['dondo_conociste']; ?>"><?php echo $user['dondo_conociste']; ?></option>
			...
			<div class="col-md-12">
				<div class="col-md-6 col-sm-6 form-group">
					<input type="text" name="dir_calle" class="form-control profile-content-input" id="inputEmail3" placeholder="Calle"
						value="<?php echo $user['calle']; ?>">
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="row">
						<div class="col-md-6 col-sm-6 form-group">
							<input type="text" name="dir_numext" class="has-error form-control profile-content-input" id="inputEmail3" 
								placeholder="Número exterior" value="<?php echo $user['dir_numext']; ?>">
						</div>
						<div class="col-md-6 col-sm-6  form-group">
							<input type="text" name="dir_numint" class="has-error form-control profile-content-input" id="inputEmail3" 
			...
			<div class="col-md-12">
				...
				<div class="col-md-6 col-sm-6  form-group">
					<select class="has-error form-control profile-content-input" name="dir_ciudad">
						<option value=0>Ciudad</option>
						<?php
							$municipios = get_municipios($user['estado']);
							if( count($municipios) > 0 ){ 
								foreach ($municipios as $municipio) { ?>
									<?php $select_municipio = ($municipio->id == $user['city'])? 'selected' : '';?>
			...
			<div class="col-md-12">
				<div class="col-md-6 col-sm-6  form-group">
					<input type="text" name="dir_colonia" class="form-control profile-content-input" id="inputEmail3" placeholder="Colonia"
						value="<?php echo $user['colonia']; ?>">				
				</div>
				<div class="col-md-6 col-sm-6 form-group ">
					<input type="text" name="dir_codigo_postal" class="form-control profile-content-input" id="inputEmail3" placeholder="Código postal"
